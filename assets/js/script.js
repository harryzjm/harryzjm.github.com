...
// Detect window size, if less than 1279px add class 'mobile' to sidebar therefore it will be auto hide when trigger the pjax request in small screen devices.
...
function afterPjax() {
  ...
  $('#post__content').children('h2,h3,h4').each(function() {
    ...
    if ($(this).prop("tagName") == 'H2') {
      ...
      toc.append('<li class="post__toc-li post__toc-h4"><a href="#' + $(this).attr('id') + '" class="js-anchor-link">' + $(this).text() + '</a></li>');
    }
  });
